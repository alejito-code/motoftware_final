...
<html lang="en">
    <head>
        ...
        <title>Cita falla mecanica</title>
                ...
                <div class="wizard-container" >
                    ...
                    <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "orange"          -->
                            ...
                            <div class="wizard-header">
                                <h3>
                                <b>AGENDAR CITA POR FALLA MECANICA<br>
                                </h3>
                            </div>

                            <div class="wizard-navigation">
                                <ul>
                                    <li><a href="#about" data-toggle="tab">Datos de reserva</a></li>
                            ...
                            <div class="tab-content" >
                                <div class="tab-pane" id="about">
                                    <h4 class="info-text"> Formulario precio a la reserva </h4>
                                <div class="row">
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group ">
                                            <label>Tipo de falla (Mecanica)</label>
                                            <select class="form-control" id="id_doctor" name="id_doctor">
                                                <option value="0">--Selecciona una opcion--</option>
                                                <option value="1">Pinchaso</option>
                                ...
                                <div class="tab-pane" id="account">
                                    <h4 class="info-text">Datos de envio</h4>
                                    <div class="row">
