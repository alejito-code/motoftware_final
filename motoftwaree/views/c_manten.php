                ...
                <div class="wizard-container" >
                    ...
                    <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "orange"          -->
                            ...
                            <div class="wizard-header">
                                <h3>
                                <b>AGENDAR CITA PARA MANTENIMIENTO<br>
                                </h3>
                            </div>

                            <div class="wizard-navigation">
                                <ul>
                                    <li><a href="#about" data-toggle="tab">Datos agenda</a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
                                            <label>Seleccione el tipo de mantenimiento</label>
                                            <select name="t_mantenimiento" id="" class="form-control">
                                                ...
                                                <option value="4">Sistema electrico</option>
                                                <option value="5">Mantinimiento general</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
