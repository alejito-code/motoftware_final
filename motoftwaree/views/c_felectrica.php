...
<html lang="en">
    <head>
        ...
        <title>Cita falla electrica</title>
                ...
                <div class="wizard-container" >
                    ...
                    <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "orange"          -->
                            ...
                            <div class="wizard-header">
                                <h3>
                                <b>AGENDAR CITA POR FALLA ELECTRICA<br>
                                </h3>
                            </div>

                            <div class="wizard-navigation">
                                <ul>
                                    <li><a href="#about" data-toggle="tab">Datos reserva</a></li>
                            ...
                            <div class="tab-content" >
                                <div class="tab-pane" id="about">
                                    <h4 class="info-text"> Formulario previo a reserva </h4>
                                <div class="row">
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group ">
                                            <label>Tipo de falla (Electica)</label>
                                            <select class="form-control" id="id_doctor" name="id_doctor">
                                                <option value="0">--Selecciona una opcion--</option>
                                                <option value="1">Sensores</option>
